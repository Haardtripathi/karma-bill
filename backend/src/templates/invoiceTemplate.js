...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .invoice-bill-to { border-right: 1px solid #bbb; flex: 1.02; }
    .invoice-details-box { flex: .98; }
    ...
    .bill-to-layout { display: grid; grid-template-columns: minmax(0, .92fr) minmax(0, 1.08fr); gap: 10px; min-height: 86px; }
    ...
    .bill-detail { font-size: 10.8px; color: #111; line-height: 1.18; overflow-wrap: anywhere; white-space: nowrap; }
    .bill-detail strong { font-weight: 800; }
    .bill-detail span { font-weight: 700; color: #1a5ce6; }
    .invoice-details-layout { display: grid; grid-template-columns: minmax(205px, 1.38fr) minmax(0, .62fr); gap: 12px; min-height: 86px; }
