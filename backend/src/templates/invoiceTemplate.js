...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .bill-to-layout { display: grid; grid-template-columns: 0.9fr 1.1fr; gap: 10px; min-height: 86px; }
    ...
    .invoice-details-layout { display: grid; grid-template-columns: 1.25fr 0.75fr; gap: 10px; min-height: 86px; }
