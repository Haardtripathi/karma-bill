...
export default function InventoryItemFormPage() {
  ...
  return (
    <section className="page">
      <div className="page-header"><div><h2>{id ? "Edit" : "Add"} Inventory Item</h2><p>Configure service or part defaults.</p></div><Link className="btn btn-secondary" to="/inventory-items">Back</Link></div>
